    ...
    <header className="sticky top-0 z-10 border-b bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container mx-auto px-4 h-16 flex items-center gap-4">
        ...
        <div className="ml-auto flex items-center gap-3">
          <div className="text-sm text-muted-foreground hidden md:block">Événement</div>
          <Select
          ...
          >
            ...
            <SelectContent>
              ...
              {state.evenements.filter((e) => e.statut === "actif").length === 0 && (
                <div className="px-3 py-2 text-sm text-muted-foreground">Aucun événement actif</div>
              )}
            </SelectContent>
          </Select>
          <NavLink to="/admin">
            <Button variant="secondary" className="hidden md:inline-flex">Gérer</Button>
          </NavLink>
        </div>
      </div>
    </header>
